...
new_data.to_csv('https://raw.githubusercontent.com/WonHyeong-Kim/AI_REAL_ESTATE_AGENCY/main/pretreatment/dataset/train_park_daycare.csv', header=True, index=False)
